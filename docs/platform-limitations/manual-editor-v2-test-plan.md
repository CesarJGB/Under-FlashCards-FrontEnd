...
| `PW-COLOR-APP-001/002` | Color propio con borrador | Primer tap, 50 movimientos, hex válido/inválido, Apply/Cancel/backdrop/Escape/Back y lado capturado. | Sheet visible al primer gesto; modelo intacto durante draft; commit único normalizado; toda cancelación conserva original. |
| `PW-IMAGE-APP-001/002/003` | Imagen con sheet y preview | Abrir sin picker, hit-test del file input, `setInputFiles`, cambiar destino, Apply/Cancel/eliminar y desmontar. | Picker solo desde gesto directo; preview sin confirmar; URL revocada; Apply único; cancel conserva imagen/lado. |
