...
| IMG-CACHE | **PARTIAL** | contrato resumen cuantificado (−99.7% chars de storage; stringify 0.43 ms); caché HTTP real sólo con assets | política TTL/invalidación, dueño de revalidación, fallback `safeLocalStorage` | No: diseñar política antes de tocar cachés |
