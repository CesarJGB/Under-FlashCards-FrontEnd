...
export default function LibraryFAB({ 
  ...
  return (
    <>
      {/* FAB Button - se oculta cuando el menú está abierto */}
      ...
      {fabOpen && (
        <div
          ...
          className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-40 animate-[fadeIn_0.2s_ease]"
        />
      )}
          ...
          <div className="px-4 pb-8 flex flex-col gap-3">
            ...
            {!isTemasLevel && (
              <button
                ...
                className="w-full bg-white border border-slate-200 rounded-3xl p-5 text-left shadow-lg hover:shadow-xl active:scale-[0.98] transition-all duration-200"
              >
                <div className="flex items-center gap-4">
            ...
            {!isTemasLevel && (
              <button
                ...
                disabled={importing}
                className="w-full bg-white border border-slate-200 rounded-3xl p-5 text-left shadow-lg hover:shadow-xl active:scale-[0.98] transition-all duration-200 disabled:opacity-50"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-slate-100 rounded-2xl flex items-center justify-center flex-shrink-0">
                    {importing ? (
