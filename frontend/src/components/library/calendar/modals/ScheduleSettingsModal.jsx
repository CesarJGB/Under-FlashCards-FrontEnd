...
export default function ScheduleSettingsModal({ scheduleName, daysCount, classes = [], onSave, onClose, saving = false }) {
  ...
  return (
    <>
      <div ref={dialogRef} tabIndex={-1} className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-[calc(1rem+env(safe-area-inset-top))] outline-none backdrop-blur-sm" role="dialog" aria-modal="true" aria-label="Ajustes del horario">
