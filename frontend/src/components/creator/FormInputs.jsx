      ...
      <div className="flex animate-[fadeIn_0.2s_ease] flex-col gap-3">
        ...
        <div>
          ...
          <textarea
            ...
            className="min-h-[176px] w-full resize-y rounded-xl border border-slate-200 bg-slate-50/40 px-3 py-2.5 text-xs font-medium leading-relaxed text-slate-800 outline-none transition-colors placeholder:text-slate-300 focus:border-indigo-300 focus:bg-white focus:ring-4 focus:ring-indigo-500/[0.08] sm:min-h-[190px]"
          />
        </div>
        ...
        <div className="flex flex-col gap-2 rounded-xl border border-slate-200 bg-slate-50/60 px-3 py-2.5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="grid w-full grid-cols-4 gap-1 rounded-xl bg-white p-1 sm:w-auto sm:min-w-[220px]">
            {[5, 10, 15].map((number) => {
              const isSelected =
                customCardCount === "" && aiNumCards === number;
              ...
              return (
                <button
                  ...
                  className={`min-h-9 rounded-lg px-2 text-xs font-extrabold transition-colors ${
                    isSelected
      ...
      <div className="flex animate-[fadeIn_0.2s_ease] flex-col gap-2.5">
        <div className="flex items-center justify-between gap-3">
          ...
          <span className="shrink-0 text-[10px] font-semibold tabular-nums text-slate-400">
            ...
            {bulkStats.completePairs === 1 ? "par" : "pares"}
          </span>
        </div>
        ...
        <textarea
          ...
          className="min-h-[190px] w-full resize-y rounded-xl border border-slate-200 bg-slate-50/40 px-3 py-2.5 font-mono text-xs leading-relaxed text-slate-800 outline-none transition-colors placeholder:text-slate-300 focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-slate-900/[0.06] sm:min-h-[210px]"
        />
