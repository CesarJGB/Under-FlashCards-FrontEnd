...
export default function DeckHeader({
  ...
  return (
    <div className="sticky top-0 z-30 -mx-4 -mt-4 md:-mx-6 md:-mt-8 w-auto px-4 py-3 min-h-[46px]">
      {/* 🎨 Capa de fondo con blur aislada para evitar conflictos con el pegajoso (sticky) */}
      <div className="absolute inset-0 bg-white/95 backdrop-blur-xl border-b border-slate-200 -z-10" />

      {/* 📦 Contenedor de elementos alineados */}
      <div className="relative flex items-center justify-center w-full">
        
        {/* 1. LADO IZQUIERDO: Botón de regreso compacto */}
        {mode !== 'review' && (
        ...
        {/* 3. LADO DERECHO: Menú de Opciones */}
        <div className="absolute right-0 flex items-center z-20">
          ...
          {/* Notificaciones de progreso / estado de exportación PDF */}
          {isExportingPdf && (
